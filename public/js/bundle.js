...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var updateSettigns = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "http://localhost:3000/api/v1/users/".concat(type === "password" ? "updatePassword" : "updateMe"),
            data: data
          });
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "".concat(type === "password" ? "Password" : "Data", " changed successfully"));
          }
          _context.next = 10;
          break;
        case 7:
  ...
  return function updateSettigns(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.updateSettigns = updateSettigns;
...
if (updateForm) {
  updateForm.addEventListener("submit", function (e) {
    ...
    (0, _updateSettings.updateSettigns)(form, "data");
  });
}
if (passwordForm) {
  passwordForm.addEventListener("submit", function (e) {
    ...
    (0, _updateSettings.updateSettigns)({
